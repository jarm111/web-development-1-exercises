...
/**
 * Locates the user and outputs the location to google map in drawn inside the document
 * @module geoModule
 * 
 * @returns {Object} has method 'initAll' that executes the module functionality
 */
